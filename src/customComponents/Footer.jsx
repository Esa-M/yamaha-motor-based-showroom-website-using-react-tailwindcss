...
export default function Footer() {
  ...
  <div>
    ...
    <p>ABCD Industries Ltd.<br/>Lorem ipsum dolor since 1992</p>
  </div> 
  <div>
...
<div className='flex flex-col justify-center align-middle '>
    <span className="footer-title self-center m-3">Social</span> 
    <div className="grid grid-flow-col h-20  flex justify-center align-middle gap-5">
